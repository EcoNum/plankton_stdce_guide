...
Au centre on retrouve la bouche de l'organisme relie par les cannaux radiaires aux gonades.

![Image de Leptomeduse *Obelia* sp [@hecq2009]](images/03plankton_gelatinous/obelia.png){width="301"}

Ce groupe n'a pas été étudié dans les précédents set d'apprentissage.

Ce groupe est similaire au groupe `obelia` dans le ZooScanNet ( @fig-zsn-obelia ).
